...
class UserSettingsDecorator
  ...
  def process_update
    ...
    user.settings['default_federate']    = default_federate_preference if change?('setting_default_federate')
  ...
  def default_federate_preference
    boolean_cast_setting 'setting_default_federate'
  end
